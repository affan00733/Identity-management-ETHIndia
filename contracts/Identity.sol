...
contract Identity is ClaimHolder {
    ...
    function getBytes(bytes _str, uint256 _offset, uint256 _length)public constant returns (bytes) {
    ...
    function getString(string _str, uint256 _offset, uint256 _length) public constant returns (string) {
